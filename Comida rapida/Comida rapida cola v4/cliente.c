...
void customerWork(int id) {
    ...
    while (1) {
        ...
        msgrcv(mainQueueId, &msg, SIZE_MSG, TYPE_CLEAN_TABLES, 0);
        ...
        msgsnd(ordersQueueId, &msg, SIZE_MSG, IPC_NOWAIT);
        if (menu) {
        ...
        msgrcv(mainQueueId, &msg, SIZE_MSG, menuType ,0);
        tableRow(columnNumber, toPrint);
